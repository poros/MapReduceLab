...
public class TextPair implements WritableComparable<TextPair> {
	...
	public boolean equals(Object o) {
		...
		return first.equals(((TextPair)o).getFirst()) && second.equals(((TextPair)o).getSecond());
	}

	@Override
	public int compareTo(TextPair tp) {
		// TODO: implement the comparison between this and tp
		if (this.getFirst().toString().compareTo(tp.getFirst().toString()) == 0) {
			return this.getSecond().toString().compareTo(tp.getSecond().toString());
		} else {
			return this.getFirst().toString().compareTo(tp.getFirst().toString());
		}
	}
